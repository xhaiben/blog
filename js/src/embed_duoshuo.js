/**
 * Created by xhaiben on 2016/12/31.
 */
!function (t, e, s) {
  if (!t.DUOSHUO) {
    ...
    !function (t, e, s) {
      "use strict";
      var i = t._ = {}, o = e.getElementsByTagName("head")[0] || e.getElementsByTagName("body")[0];
      i.extend = function (t, e) {
        ...
        var n = e.createElement("script"), a = e.head || e.getElementsByTagName("head")[0] || e.documentElement;
        ...
        for (var i, o, n, a = " " + t + "=", r = e.cookie.split(";"), d = 0; d < r.length; d++)if (i = " " + r[d], o = i.indexOf(a), o >= 0 && o + a.length == (n = i.indexOf("=") + 1))return decodeURIComponent(i.substring(n, i.length).replace(/\+/g, ""));
        return s
      }, i.param = function (t) {
        var e = [];
        ...
        for (var o = ["Moz", "Webkit", "ms"], t = t.charAt(0).toUpperCase() + t.substr(1), n = 0; n < o.length; n++)if ("string" == typeof i[o[n] + t])return s ? o[n] + t : !0
      }
    }(t, e);
    ...
    !function (t) {
      ...
      function o(t, e, o) {
        ...
        h(t, "each");
        var a, d = t.outerHTML, c = t.previousSibling, l = t.parentNode, p = [], m = [];
          ...
          if (t) {
            ...
            u(t, function (s, c) {
              ...
              if (0 > f) {
                ...
                var _ = new r({tmpl: d}, {before: b[h + u], parent: e, root: l, item: y || s});
        ...
        v(t, function (t) {
          ...
          if (3 == s && "STYLE" != t.parentNode.tagName && i(t, t.nodeValue), 1 == s) {
            ...
            return n ? (o(t, e, n), !1) : (u(t.attributes, function (e) {
              var s = e.name, o = s.split("__")[1];
              return i(t, e.value, {attr: o || s, bool: o}), o ? (h(t, s), !1) : void 0
            }), U(t) ? !1 : void 0)
          }
        })
      }
      ...
      function r(t, e, s) {
        ...
        var r, d = w.observable(this), c = _(e.opts) || {}, h = g(t.tmpl), m = e.parent, f = [], v = [], y = e.root, O = e.item, U = t.fn, S = y.tagName.toLowerCase(), k = {};
        U && y._tag && y._tag.unmount(!0), y._tag = this, this._id = ~~((new Date).getTime() * Math.random()), p(this, {
          ...
          if (i(), U && U.call(d, c), o(!0), a(h, d, f), d.parent || d.update(), d.trigger("premount"), U)for (; h.firstChild;)y.appendChild(h.firstChild); else r = h.firstChild, y.insertBefore(r, e.before || null);
          y.stub && (d.root = y = m.root), d.trigger("mount")
        }, this.unmount = function (t) {
          var e = U ? y : r, s = e.parentNode;
          if (s) {
            if (m) Array.isArray(m.tags[S]) ? u(m.tags[S], function (t, e) {
              t._id == d._id && m.tags[S].splice(e, 1)
            }) : delete m.tags[S]; else for (; e.firstChild;)e.removeChild(e.firstChild);
            t || s.removeChild(e)
          }
      ...
      function l(t, s, i) {
        u(t, function (t) {
          var o = t.dom, n = t.attr, a = H(t.expr, s), r = t.dom.parentNode;
          if (null == a && (a = ""), r && "TEXTAREA" == r.tagName && (a = a.replace(/riot-/g, "")), t.value !== a) {
            if (t.value = a, !n)return o.nodeValue = a;
            if (h(o, n), "function" == typeof a) d(n, a, o, s, i); else if ("if" == n) {
              var l = t.stub;
              a ? l && c(l.parentNode, l, o) : (l = t.stub = l || e.createTextNode(""), c(o.parentNode, o, l))
            } else if (/^(show|hide)$/.test(n)) "hide" == n && (a = !a), o.style.display = a ? "" : "none"; else if ("value" == n) o.value = a; else if ("riot-" == n.slice(0, 5)) n = n.slice(5), a ? o.setAttribute(n, a) : h(o, n); else {
              if (t.bool) {
                if (o[n] = a, !a)return;
                a = n
              }
      ...
      function m() {
        if (t) {
          var e = navigator.userAgent, s = e.indexOf("MSIE ");
          return s > 0 ? parseInt(e.substring(s + 5, e.indexOf(".", s)), 10) : 0
        }
      }

      function f(t, s) {
        var i = e.createElement("option"), o = /value=[\"'](.+?)[\"']/, n = /selected=[\"'](.+?)[\"']/, a = s.match(o), r = s.match(n);
        i.innerHTML = s, a && (i.value = a[1]), r && i.setAttribute("riot-selected", r[1]), t.appendChild(i)
      }

      function g(t) {
        var s = t.trim().slice(1, 3).toLowerCase(), i = /td|th/.test(s) ? "tr" : "tr" == s ? "tbody" : "div", o = e.createElement(i);
        return o.stub = !0, "op" === s && x && 10 > x ? f(o, t) : o.innerHTML = t, o
      }

      function v(t, e) {
        if (t)if (e(t) === !1) v(t.nextSibling, e); else for (t = t.firstChild; t;)v(t, e), t = t.nextSibling
      }
      ...
      var w = {version: "v2.0.15", settings: {}}, x = m();
      w.observable = function (t) {
        ...
        return t.on = function (i, o) {
          ...
          return "*" == s ? e = {} : s.replace(/\S+/g, function (t) {
            if (i)for (var s, o = e[t], n = 0; s = o && o[n]; ++n)s._id == i._id && (o.splice(n, 1), n--); else e[t] = []
          }), t
        }, t.one = function (e, s) {
          function i() {
        ...
        if (s) {
          var a, r = s.location, d = t.observable(), c = s, l = !1, u = t.route = function (t) {
      ...
      var D = function (t, e, s) {
        ...
        function n(t, e, s) {
          var i, o = 0, n = [], a = new RegExp("(" + e.source + ")|(" + s.source + ")", "g");
          return t.replace(a, function (e, s, a, r) {
            !o && s && (i = r), o += s ? 1 : -1, o || null == a || n.push(t.slice(i, r + a.length))
          }), n
        }

        var a = {}, r = /(['"\/]).*?[^\\]\1|\.\w*|\w*:|\b(?:(?:new|typeof|in|instanceof) |(?:this|true|false|null|undefined)\b|function *\()|([a-z_$]\w*)/gi;
        return function (t, s) {
          return t && (a[t] = a[t] || e(t))(s)
        }
      }(), T = [], M = {};
      w.tag = function (t, e, s, i) {
        return "function" == typeof s ? i = s : s && S(s), M[t] = {name: t, tmpl: e, fn: i}, t
      }, w.mount = function (t, e, s) {
        function i(t) {
          var i = e || t.getAttribute("riot-tag") || t.tagName.toLowerCase(), o = k(t, i, s);
          o && a.push(o)
        }
        ...
        if ("object" == typeof e && (s = e, e = 0), "string" == typeof t ? ("*" == t && (t = n(t)), o = y(t)) : o = t, "*" == e) {
          if (e = n(t), o.tagName) o = y(e, o); else {
            var r = [];
            u(o, function (t) {
              r = y(e, t)
            }), o = r
    ...
    }("undefined" != typeof t ? t : s), function (t, e) {
      "use strict";
      function s(t) {
      ...
      function m() {
        if (this.el && this.el.getBoundingClientRect) {
          ...
          return {top: t.top + e.body.scrollTop, left: t.left + e.body.scrollLeft, height: t.height}
        }
      }

      function f() {
        return this.el ? {left: this.el.offsetLeft, top: this.el.offsetTop} : void 0
      }
      ...
      function o() {
        var s = t.navigator.userAgent, i = e.createElement("div");
        i.innerHTML = '<a href="/a" style="opacity:.55;">a</a><input type="checkbox"/>';
        var o = i.getElementsByTagName("a")[0], n = i.getElementsByTagName("input")[0], a = {
          ...
          if ("object" == typeof s) {
            ...
            _.each(s, function (n) {
              e[n] || (o = !1, _.injectScript(t(n), function () {
                e[n] = !0;
                for (var t = 0; t < s.length; t++)if (!e[s[t]])return;
                i()
              }))
            }), o && i()
          }
      ...
      function r(t) {
        ...
        var s = l.API, i = l.utils;
        d(("string" == typeof t ? [t] : t) || null), e()
      }

      function d(t) {
        var e = l.components, s = ["thread", "recent-comments", "recent-visitors", "top-users", "top-threads", "login", "thread-count", "share", "share-aside"];
        _.each(t || s, function (t) {
          if (!e[t]) {
            var s = 0 === t.indexOf("ds-") ? t : "ds-" + t, i = riot.mount("." + s, s);
      ...
      var l = t.DUOSHUO = riot.observable(), u = ["status", "smilies", "visitor", "site", "unread", "utils", "components", "notifications", "constents"];
      ...
      function d(e) {
        function s(e, s) {
          ...
          return t.open(s + (-1 == s.indexOf("?") ? "?" : "&") + _.param({origin: i.origin || "http://" + i.host}), "_blank", "width=" + o[0] + ",height=" + o[1] + ",toolbar=no,menubar=no,location=yes")
        }
      ...
      var l = $ds, u = DUOSHUO.utils, h = t._dom;
      u.mountTag = s;
      var p = u.dialog = {};
      p.open = i, p.close = o;
      var m = u.indicator = {};
      ...
      {
        var i = DUOSHUO.utils, o = t.localStorage;
        i.cache = {}
      }
      ...
      function s(t) {
        var e = i.parseDate(t), s = new Date, o = (s - DUOSHUO.constents.timeOffset - e) / 1e3;
      ...
      function o() {
        ...
        return t ? {jwt: t} : duoshuoQuery.remote_auth ? {
      ...
      function n() {
        if (!duoshuoQuery && (duoshuoQuery = t.duoshuoQuery)) {
          if (!duoshuoQuery.short_name || "your_duoshuo_short_name" === duoshuoQuery.short_name)return duoshuoQuery = s, c.errors.handle("missing_dsq_shortname", {showAlert: !0});
      ...
      function s(e) {
        var s = duoshuoQuery.sso && duoshuoQuery.sso.login ? {sso: 1, redirect_uri: duoshuoQuery.sso.login} : null;
      ...
      function o() {
        var e = duoshuoQuery.sso && duoshuoQuery.sso.logout ? {sso: 1, redirect_uri: duoshuoQuery.sso.logout} : null;
        return t() + "/logout/" + c(e)
      }
      ...
      var d = DUOSHUO.utils, c = d.queryIfNecessary;
      ...
      function s(t, s) {
        if (t.visitor) {
          ...
          o && DUOSHUO.ws.send({logged_user_id: t.visitor.user_id}), DUOSHUO.visitor = t.visitor
        }
        if (t.site && (DUOSHUO.site = t.site, n.save("ds_site_" + duoshuoQuery.short_name, t.site)), !DUOSHUO.theme && DUOSHUO.site.theme && e(DUOSHUO.site.theme, s), t.lang && (_.extend(DUOSHUO._lang, t.lang), n.save("ds_lang_" + duoshuoQuery.short_name, t.lang)), t.stylesheets)for (var r = 0; r < t.stylesheets.length; r++)_.injectStylesheet(t.stylesheets[r]);
        if (t.nonce && (DUOSHUO.nonce = t.nonce), t.style && _.injectStyle((t.style || "") + i(duoshuoQuery.component_style)), t.unread && (DUOSHUO.unread = t.unread), t.warnings)for (var r = 0; r < t.warnings.length; r++)console.warn(t.warnings[r])
      }
      ...
      var o = DUOSHUO.utils, n = o.cache, a = t.Notification;
      ...
      function e() {
        function e() {
          for (var e; e = o.shift();) {
            var s = e.url, n = new i(e.title, {dir: "auto", icon: e.iconUrl, body: e.body});
            try {
              n.onclick = function () {
      ...
      var s = DUOSHUO.utils, i = t.Notification, o = DUOSHUO.notifications;
      ...
      function e(t, e) {
        ...
        var i = o[parseInt(s[0]) - 1], a = (n[parseInt(s[1]) - 1], {E: "error", W: "warn", N: "info"});
      ...
      var i = t.utils, o = ["E", "W", "N"], n = ["V", "S", "B"], a = {
        missing_dsq: {
          code: "12",
        ...
        missing_message: {code: "11", errorMessage: "您还没写内容呢"},
        missing_email: {code: "11", errorMessage: "请输入一个有效的 Email 地址"},
        missing_data_url: {code: "12", errorMessage: "请设置 data-url"},
        missing_thread_key: {code: "12", errorMessage: "请设置正确的 data-thread-key 属性"},
        missing_share_type: {code: "11", errorMessage: "还没有选发布到哪儿呢"},
        define_dsq: {code: "22", errorMessage: "请在加载多说 embed.js 之前定义 duoshuoQuery"},
        "default": {code: "12", errorMessage: "啊喔，出错了"}
      };
      i.errors = {}, i.errors.handle = s
    }(t.DUOSHUO), function (t, e, s, i) {
      "use strict";
      function o(e, o, n, a, r) {
        ...
        function p(t, e, s) {
          var i, o, n, d = e;
          if (t >= 200 && 300 > t || 304 === t)if (304 === t) d = "notmodified", n = !0; else try {
        ...
        if (f) {
          var g = new XMLHttpRequest, v = !!g && "withCredentials" in g;
          if (v) {
            var b;
            ...
            return g.send("GET" == e ? null : _.param(n)), b = function (t, e) {
              var s, o, n, a;
              try {
                if (b && (e || 4 === g.readyState))if (b = i, e) 4 !== g.readyState && g.abort(); else {
      ...
      var d = s.API = {}, c = s.utils, l = c.cache, u = c.errors.handle, h = {};
      d.ajax = o, d.get = n, d.post = a
    }(t, e, t.DUOSHUO), function (t, e, s) {
      "use strict";
      function i(i) {
        function a() {
          function i() {
            var t, e = 1 === c.readyState;
            if (e)for (; t = r.messages.shift();)c.send(t)
          }
          ...
          var d = "https:" === e.location.protocol ? "wss://ws.duoshuo.com:8202/" : "ws://ws.duoshuo.com:8201/", c = r.webSocket = new WebSocket(d);
      ...
      var o = s.utils, n = s.notifications, a = s.ws = {};
      a.messages = [], a.send = i
    }(t, e, t.DUOSHUO);
    ...
    DUOSHUO.DOMAIN = "duoshuo.com", DUOSHUO.STATIC_URL = n + "//static.duoshuo.com", DUOSHUO.REMOTE = n + "//duoshuo.com", DUOSHUO.version = "15.5.20", DUOSHUO._styleMd5 = {
      ...
      bluebox: "0f0f035c",
      newhua: "dc453ca2"
    }, DUOSHUO._libsMd5 = {"embed.compat": "24f8ca3f", smilies: "921e8eda"}, DUOSHUO._lang = {
      post: "发布",
      posting: "正在发布",
      settings: "设置",
      reply: "回复",
      ...
      var s = this, i = this.bubble = DUOSHUO.components.bubble;
      ...
      var t = $ds, e = this, s = {}, i = bubbleOutTimer = 0;
      this.style = "display: none", this.hide = function () {
        ...
        function a() {
          ...
          var n = c.offset(), a = t(d).offset(), l = (c.el.offsetWidth + 40) / 2, u = d.offsetHeight - (n.top - a.top) + 6, h = n.left - a.left - 35 + (l > 35 ? 35 : l);
        ...
        var r = n.target, d = e.root.parentElement;
      ...
      var e = DUOSHUO.API, s = DUOSHUO.utils.dialog;
      ...
      var s = $ds, i = this, o = (DUOSHUO.API, this.bubble = DUOSHUO.components.bubble), n = DUOSHUO.components.thread, a = n.tags["ds-comments"].tags["ds-paginator"];
      ...
      this.utils = DUOSHUO.utils, this.lang = DUOSHUO._lang, this.showDsCtxNth = function () {
        return t.index >= 0
      }.bind(this), this.expandClick = function () {
      }.bind(this)
      ...
      this.lang = DUOSHUO._lang;
      var e = DUOSHUO.components.thread || (t.normal ? o.parent : o.parent.parent), s = e.tags["ds-comments"], i = this.parent, o = i.parent;
      this.reply = function () {
        ...
        if (o.lastOpenId && o.lastOpenId !== t.post_id && (o.replyboxOpen = !0), o.replyboxOpen) {
          ...
          var e = {commentsTag: s, options: o.opts.options, thread: o.opts.thread, parent_id: t.post_id, inline: !0};
      ...
      var e = DUOSHUO.API, s = DUOSHUO.utils, i = DUOSHUO.utils.dialog;
      this.like = function () {
        if (s.isGuest())return void i.open("ds-services-list", {title: "社交帐号登录", style: "width: 300px;"});
        var o = this.parent.comment || this.parent.opts.comment, n = (t.likes, o.vote > 0), a = {};
      ...
      var t = $ds;
      this.lang = DUOSHUO._lang;
      var e = DUOSHUO.API, s = this.parent.comment, i = DUOSHUO.components.thread, o = i.tags["ds-comments"];
      ...
      this.lang = DUOSHUO._lang;
      var s = DUOSHUO.utils, i = DUOSHUO.visitor, o = s.dialog;
      this.repost = function () {
        var s = t.comment, n = s.source;
        return i.social_uid["qqt" == n ? "qq" : n] ? void o.open("ds-dialog-reposts", {comment: t.comment}) : e(n)
      }.bind(this)
      ...
      var i = $ds, o = (t._dom, this), n = DUOSHUO.utils;
      this.lang = DUOSHUO._lang, this.current = {}, this.on("update", function () {
        ...
        var o = this.parent.tags["ds-paginator"], n = t.target.getAttribute("data-type"), a = t.target.getAttribute("data-v");
      ...
      this.utils = DUOSHUO.utils, this.visitor = DUOSHUO.visitor, this.sourceName = DUOSHUO.constents.sourceName, this.services = ["weibo", "qq", "renren", "kaixin", "douban"], this.on("mount", function () {
        ...
        }), void this.utils.dialog.close()) : this.utils.errors.handle("missing_email", {showAlert: !0})
      }.bind(this)
    }), riot.tag("ds-dialog-ctx-comments", '<h2>查看对话</h2><ol id="ds-ctx"><ds-context-comment each="{ comment, index in opts.comments }" index="{ this.index }" comment="{ this.comment }"></ds-context-comment></ol>', function () {
    }), riot.tag("ds-dialog-qrcode", '<h2>微信扫一扫，分享到朋友圈</h2><div class="ds-share-qrcode" style="text-align:center;"><img riot-src="{ opts.qrcode_url }" alt="{ opts.url }"></div>', function () {
    }), riot.tag("ds-dialog-reposts", '<h2>转发到微博</h2><div class="ds-quote"><strong>@{ comment.author.name }</strong>: <ds-comment-message-raw message="{ comment.message }"></ds-comment-message-raw></div><form id="repostForm" onsubmit="{ submitRepost }"><div class="ds-textarea-wrapper"><textarea name="message" title="Ctrl + Enter 快捷提交" placeholder="{ lang.repost_reason }">{ opts.repostMessage || \'\' }</textarea><pre class="ds-hidden-text"></pre></div><div class="ds-actions"><label if="{ !opts.service }"><input type="checkbox" name="service[]" value="weibo" __checked="{ shareVia.weibo }" onclick="{ toggleCheck }"><span class="ds-service-icon ds-weibo"></span>新浪微博 </label><label if="{ !opts.service }"><input type="checkbox" name="service[]" value="qqt" __checked="{ shareVia.qqt }" onclick="{ toggleCheck }"><span class="ds-service-icon ds-qqt"></span>腾讯微博 </label><button type="submit">{ lang.repost }</button></div></form>', function (t) {
      function e(t) {
        var e = [];
      ...
      var s = DUOSHUO.API, i = DUOSHUO.utils, o = i.dialog;
      this.lang = DUOSHUO._lang, this.service = t.service, this.comment = t.comment, this.shareVia = {}, this.on("mount", function () {
        ...
        if (!this.service && !this.shareVia.weibo && !this.shareVia.qqt)return i.errors.handle("missing_share_type", {showAlert: !0});
        var n = {};
      ...
      this.root.innerHTML = t.message
    }), riot.tag("ds-error", '<p if="{ opts.error }">评论框出错啦({ opts.error.code }): { opts.error.message }</p>', function () {
    }), riot.tag("ds-indicator", '<div id="ds-indicator" style="display: block;"></div>', function () {
    }), riot.tag("ds-waiting", '<div id="ds-waiting"></div>', function () {
    }), riot.tag("ds-login", '<div id="ds-login" class="ds-login ds-icons-32"><a each="{ service in services }" onclick="{ parent.utils.authClick }" class="ds-{ service }" href="{ parent.loginUrl(service) }">{ parent.sourceName[service] }</a></div>', function (t) {
      ...
      this.services = {}, this.styles = "left: 0px; top: 35px; display: none;", this.on("update", function () {
        Object.keys(s).forEach(function (i) {
          t.services[i] = {
            text: s[i],
            link: e.hostUrl() + "/share-proxy/?" + _.param({service: i, thread_id: t.opts.threadid})
          }
        })
      ...
      var e = $ds, s = (DUOSHUO.utils, this.dialog = DUOSHUO.utils.dialog);
      DUOSHUO.updateWhenReady(this), this.on("update", function () {
      ...
      var s = $ds, i = this.parent.parent, o = DUOSHUO.utils;
      ...
      var i, o = $ds, n = this, a = this.utils = DUOSHUO.utils, r = (a.events, DUOSHUO.API), d = this.submit, c = this.dialog = a.dialog;
      this.lang = DUOSHUO._lang, this.status = {}, this.on("update", function () {
        ...
        var e = this.message, s = e.value.trim(), i = DUOSHUO.environment.supports;
        if (!s || "" == s || !i.placeholder && s == e.getAttribute("placeholder"))return a.errors.handle("missing_message", {showAlert: !0});
        ...
        var s = (t._dom, n.message), o = s.getBoundingClientRect();
        ...
        var t = n.dsMessageTextarea, s = t.value, i = "请输入图片地址", o = '<img src="' + i + '" />';
        if (e.selection) {
      ...
      this.styles = "display: none;", t.position && (this.styles += "top:" + t.position.top + ";", this.styles += "left:" + t.position.left, this.styles += "; overflow: hidden;"), this.on("update", function () {
        ...
        var s = e.getElementById("dsMessageTextarea"), i = s, o = i.value, n = t.item.shortCut;
        if (e.selection) {
      ...
      var i = $ds, o = this, n = DUOSHUO.API, a = DUOSHUO.utils, r = DUOSHUO.components, d = "thread-id local-thread-id source-thread-id thread-key category channel-key author-key author-id url limit order max-depth form-position container-url title image thumbnail";
      if (this.data = {}, this.ready = !1, "请将此处替换成文章在你的站点中的ID" === t["data-thread-key"])return a.errors.handle("missing_thread_key", {showAlert: !0});
      ...
      c ? t["data-url"] = a.resolveUrl(c) : t["data-container-url"] = location.href, this.fetch = function (e, i) {
        ...
        o.error = {code: e, message: t}, o.ready = !0, o.update()
      }.bind(this)
      ...
      var t = $ds, e = this.utils = DUOSHUO.utils, s = this.dialog = e.dialog;
      ...
      var s = this, i = DUOSHUO.utils, o = "show-time avatar-size num-items channel-key";
      ...
      function e(t) {
        if (t.response && t.response[a]) {
          var e = i.opts, n = "comments", r = t.response[a][n], d = _.extend(DUOSHUO._lang, t.options);
          s(o)[e.replace || e["data-replace"] ? "replaceWith" : "html"](d[n + "_" + (r ? r > 1 ? "multiple" : "one" : "zero")].replace("{num}", r))
        }
      }

      var s = $ds, i = this, o = this.root, n = (DUOSHUO.utils, {});
      n.__comboMode = t.combo || !0;
      var a = n.threads = t["thread-key"] || t["data-thread-key"], r = t["channel-key"] || t["data-channel-key"];
      ...
      var s = this, i = DUOSHUO.utils, o = "range num-items channel-key";
      ...
      var i = DUOSHUO.utils, o = i.dialog, n = ["weibo", "qzone", "sohu", "renren", "netease", "qqt", "kaixin", "douban", "qq", "meilishuo", "mogujie", "baidu", "taobao", "google", "wechat", "diandian", "huaban", "duitang", "youdao", "pengyou", "facebook", "twitter", "linkedin", "msn"];
      this.sourceName = DUOSHUO.constents.sourceName, this.on("update", function () {
        this.size = s.size || 16, this.services = s.services ? s.services.split(",") : n
      }), this.share = function (n) {
        var a = n.target.getAttribute("data-service"), r = s.shareoptions["data-url"];
        if (!r)return i.errors.handle("missing_data_url", {showAlert: !0});
        if ("wechat" === a) {
          var d = i.hostUrl() + "/api/qrcode/getImage.png", c = "?size=240&text=" + r, l = $ds("#dsDialogContent");
      ...
      "use strict";
      var s = e.utils, i = s.errors.handle;
